<%@ Page Title="" Language="C#" EnableEventValidation="false" MasterPageFile="~/iljin.Master" AutoEventWireup="true" CodeBehind="Frmpayments.aspx.cs" Inherits="iljin.Frmpayments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <article class ="conts_inner">
        <h2 class="conts_tit">
            <asp:Label ID="m_title" runat="server" Text="경영통계 ::> 수불집계"></asp:Label>
        ...
        <div id="exceldiv" runat="server" class ="fixed_hs_650 mt10" style="width:1190px; overflow:hidden;">
            <table class ="grtable_th">
                <thead>
                    <tr>
                        <th class="mWt16p">거래처</th>
                        <th class="mWt12p">금월</th>
                        <th class="mWt12p">1개월 후</th>
                        <th class="mWt12p">2개월 후</th>
                        <th class="mWt12p">3개월 후</th>
                        <th class="mWt12p">4개월 후</th>
                        <th class="mWt12p">5개월 후</th>
                        <th class="mWt12p">6개월 후</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                ...
                <tfoot>
                    <tr>
                       <th class="mWt16p">합계</th>
                        <th class="mWt12p" id="month0" runat="server"></th>
                        <th class="mWt12p" id="month1" runat="server"></th>
                        <th class="mWt12p" id="month2" runat="server"></th>
                        <th class="mWt12p" id="month3" runat="server"></th>
                        <th class="mWt12p" id="month4" runat="server"></th>
                        <th class="mWt12p" id="month5" runat="server"></th>
                        <th class="mWt12p" id="month6" runat="server"></th> 
                    </tr>
                </tfoot>
            </table>
        </div>
