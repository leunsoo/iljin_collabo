<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="popfinish.aspx.cs" Inherits="iljin.popUp.popfinish" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table class="itable_1 mt10">
            <tobody>
                ...
                <asp:Label ID="txt_containerno" runat="server"></asp:Label>
                    ...
                    <th>입고일자</th>
                    <td>
                      <asp:Label ID="txt_incomedate" runat="server"></asp:Label>
                        </td> 
                    <th>담당자</th>
                    <td>
            ...
            <table class="grtable_th">                
                ...
                <tfoot>
                    <tr>
                        ...
                        <th ><asp:Label ID="txt_totalQty" runat="server"></asp:Label></th>
                        <th></th>
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="tar mt20">
  <button type="button" class="btn_150_40 btn_gray" onclick="self.close()">목록</button>
