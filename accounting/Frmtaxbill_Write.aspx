        ...
        <div class ="search_box">
            <div class ="box_row">
                ...
                <asp:TextBox ID ="txt_customer" runat="server" CssClass="mWt150" onkeydown="KeyDownEvent();" onclick="visibleChk();" onkeypress="KeyPressEvent();" autocomplete="off"></asp:TextBox>
                 <asp:Button ID ="btn_sch" runat="server" CssClass="btn_navy btn_100_30 ml5" Text="조회" OnClick="btn_sch_Click" />
                 <asp:Button ID ="btn_taxbill" runat="server" CssClass="btn_black btn_100_30 ml5" Text="이전화면" OnClientClick="move_to_taxbill();return false;" />
                 <asp:Button ID ="btn_seperateSent" runat="server" CssClass="btn_navy btn_100_30 ml5" OnClientClick="seperatesent();return false;" Text="별도발행"/>
                 <asp:Button ID ="btn_sent" runat="server" CssClass="btn_navy btn_100_30 ml5" OnClientClick="sent();return false;" Text="세금계산서 발행"/>
                 <asp:Button ID="btn_excel" runat="server" CssClass="btn_100_30 btn_green ml5" Text="엑셀다운로드" OnClick="btn_excel_Click"  />                                                                                
         </div>
            </div>
