<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="popwork.aspx.cs" Inherits="iljin.popUp.popwork" EnableEventValidation="false" %>
            ...
            <table class="itable_1 mt10">
                <tobody>
                    ...
                    <tr>
                        ...
                        <th>일련번호</th>
                        <td>
                            <asp:Label ID="txt_serialNo" runat="server" CssClass="ml10"></asp:Label>
                        </td>
                    </tr>
            </table>
            <div class="title_1 mt20">
